...
class CommentAdapter (val context: Context, val comments: List<Comment>): RecyclerView.Adapter<CommentAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        private fun popupMenus(view: View, commentID: String, postID: String) {
            ...
            commentRef.document(commentID).addSnapshotListener { value, error ->
                ...
                dia.findViewById<Button>(R.id.btnDelete)?.setOnClickListener {
                    AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Yes"){
                            ...
                            postRef.document(postID).update("Comments", FieldValue.arrayRemove(commentID))
                ...
                dia.findViewById<Button>(R.id.btnReport)?.setOnClickListener {
                    AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Yes") { dialog, _ ->
                            ...
                            val communityCommentsReportsRef =
                                Firebase.firestore.collection("CommunityCommentsReports")
                            val autoGeneratedReportID = communityCommentsReportsRef.document().id
                            val reporterID: Any?
                            if (Firebase.auth.currentUser != null) {
                                ...
                                communityCommentsReportsRef.document(autoGeneratedReportID)
                                    .set(reportData)
